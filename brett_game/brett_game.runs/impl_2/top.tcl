...
set rc [catch {
  ...
  set_property ip_repo_paths c:/Brett/School/Spring15/541/labs/brett_game/brett_game.cache/ip [current_project]
  set_property ip_output_repo c:/Brett/School/Spring15/541/labs/brett_game/brett_game.cache/ip [current_project]
  add_files -quiet C:/Brett/School/Spring15/541/labs/brett_game/brett_game.runs/synth_2/top.dcp
...
set rc [catch {
  ...
  if { [file exists C:/Brett/School/Spring15/541/labs/brett_game/brett_game.runs/synth_2/top.hwdef] } {
    catch { write_sysdef -hwdef C:/Brett/School/Spring15/541/labs/brett_game/brett_game.runs/synth_2/top.hwdef -bitfile top.bit -meminfo top.mmi -file top.sysdef }
  }
