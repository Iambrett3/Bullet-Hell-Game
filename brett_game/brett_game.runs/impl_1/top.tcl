...
set rc [catch {
  ...
  add_files -quiet C:/Brett/School/Spring15/541/labs/brett_game/brett_game.runs/synth_1/top.dcp
...
set rc [catch {
  ...
  if { [file exists C:/Brett/School/Spring15/541/labs/brett_game/brett_game.runs/synth_1/top.hwdef] } {
    catch { write_sysdef -hwdef C:/Brett/School/Spring15/541/labs/brett_game/brett_game.runs/synth_1/top.hwdef -bitfile top.bit -meminfo top.mmi -file top.sysdef }
  }
